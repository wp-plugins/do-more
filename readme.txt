...
Tags: more, more tag, post, posts, seo, penguin, panda
...
Do more with the `<!--more-->` Tag. This plugin makes all links below the `<!--more-->` tag include the rel="nofollow" attribute.
...
1. Activate the "Do More" plugin in the 'Plugins' menu in WordPress
1. Enjoy doing more with your links
